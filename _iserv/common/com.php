			...
			if($lang == 'fr') {
				return array(
					 'maintenance'=> array (
					 		...
					 		'content' => "Désolé pour ce désagrément, nous effectuons actuellement des travaux de maintenance. Vous pouvez toutefois <a href=\"mailto:75827085@continental.edu.pe\">nous contacter</a> si besoin, mais nous serons de retour sous peu !",
					 		'sign' => "— L'équipe",
					 ),
				...
				return array(
					 'maintenance'=> array (
					 		...
					 		'content' => "Sorry for the inconvenience but we&rsquo;re performing some maintenance at the moment. If you need to you can always <a href=\"mailto:75827085@continental.edu.pe\">contact us</a>, otherwise we&rsquo;ll be back online shortly!",
					 		'sign' => "— The Team",
					 ),
					 'order_notify_messages' => array (
